  ...
  "@graph": [
    {
      "@type": "WebSite",
      name: "ワクツク",
      url: "https://wakutsuku-lab.github.io/",
      description: "仕事道具の仕様、互換性、向いている条件を公式情報から整理するメディアです。",
      inLanguage: "ja",
      publisher: { "@id": "https://wakutsuku-lab.github.io/#organization" },
    },
    {
      "@type": "Organization",
      "@id": "https://wakutsuku-lab.github.io/#organization",
      name: "ワクツク",
      url: "https://wakutsuku-lab.github.io/",
      email: "wakutsuku.lab@gmail.com",
      logo: "https://wakutsuku-lab.github.io/favicon.svg",
    },
  ],
};
...
export default function Home() {
  return <main>
    ...
    <section className="articles" id="articles"><div className="shell"><div className="section-heading"><div><p className="section-number">02 / ARTICLES</p><h2>モバイルモニター特集</h2></div><span>19 GUIDES</span></div>{[
      ...
      ["/articles/mobile-monitor-vs-desktop","据え置き型との違い","机、収納、移動頻度から選ぶ"],
      ["/articles/mobile-monitor-dual-display","2台接続する前の確認","PCの出力上限、映像経路、給電を整理"],
      ["/articles/mobile-monitor-ipad","iPadとの接続条件","モデル、表示方法、ケーブルを確認"],
    ...
    <footer id="contact"><div className="shell footer-grid"><div><p className="footer-brand">WAKUTSUKU</p><p>選ぶ条件を、わかりやすく。</p></div><div><p className="footer-label">INFORMATION</p><p><Link href="/about">運営情報</Link><br/><Link href="/advertising-policy">広告・アフィリエイト方針</Link><br/><Link href="/privacy">プライバシーポリシー</Link><br/><Link href="/contact">お問い合わせ</Link></p></div><div><p className="footer-label">NOTICE</p><p>当サイトはアフィリエイト広告を利用しています。</p></div></div><div className="shell copyright">© 2026 WAKUTSUKU</div></footer>
  </main>;
}
